...
import type { SalesReportScope } from "@/modules/products/domain/models/sales-report.model";
import { useState } from "react";
import { SalesReportProductSearch } from "./SalesReportProductSearch";

interface SalesReportProductSelectorProps {
...
export const SalesReportProductSelector: React.FC<
  SalesReportProductSelectorProps
> = ({
  scope,
  products,
  selectedProductId,
    ...
    return (
      <div>
        ...
        <div className="space-y-2">
          <SalesReportProductSearch onSearch={setSearchTerm} />

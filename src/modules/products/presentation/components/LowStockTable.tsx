...
import { NewStockEntryModal } from "./stock-entries/NewStockEntryModal";
...
export const LowStockTable: React.FC<LowStockTableProps> = ({
  ...
  const calculateScheduledPrice = (
    ...
    if (discountType === 1) return salePrice - discountValue;
    return salePrice;
  };
  ...
  return (
    <>
              ...
              {paginatedItems.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Botón Reabastecer en lugar de Editar */}
                    <td className="p-4 text-right">
                      <Button
                        variant="primary"
                        className="text-sm"
      ...
      {/* Modal de nueva entrada pre-cargado con el producto */}

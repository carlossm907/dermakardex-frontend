...
import { EntriesReportProductSearch } from "./EntriesReportProductSearch";
import type { Product } from "@/modules/products/domain/models/product.model";
import type { EntriesReportScope } from "@/modules/products/domain/models/entries-report.model";

interface EntriesReportProductSelectorProps {
  scope: EntriesReportScope;
  products: Product[];
...
export const EntriesReportProductSelector: React.FC<
  EntriesReportProductSelectorProps
> = ({
  scope,
  products,
  selectedProductId,
  ...
  const listClass =
    "border border-neutral-200 rounded-lg max-h-48 overflow-y-auto bg-white divide-y divide-neutral-100";
    ...
    return (
      <div>
        ...
        <div className="space-y-2">
          <EntriesReportProductSearch onSearch={setSearchTerm} />

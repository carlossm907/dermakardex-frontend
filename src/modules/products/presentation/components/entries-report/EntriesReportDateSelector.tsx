...
import type { EntriesReportDateMode } from "../../../domain/models/entries-report.model";
import { Button } from "../../../../../shared/components/ui/Button";

interface EntriesReportDateSelectorProps {
  from: string;
  to: string;
  mode: EntriesReportDateMode;
  onModeChange: (mode: EntriesReportDateMode) => void;
...
export const EntriesReportDateSelector: React.FC<
  EntriesReportDateSelectorProps
> = ({
  from,
  to,
  mode,
  ...
  const handleModeChange = (newMode: EntriesReportDateMode) => {

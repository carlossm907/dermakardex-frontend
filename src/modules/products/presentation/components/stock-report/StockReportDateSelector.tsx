import type { StockReportDateMode } from "@/modules/products/domain/models/stock-report.model";
import { Button } from "@/shared/components/ui/Button";
import { useState } from "react";

interface StockReportDateSelectorProps {
  from: string;
  to: string;
  mode: StockReportDateMode;
  onModeChange: (mode: StockReportDateMode) => void;
...
export const StockReportDateSelector: React.FC<
  StockReportDateSelectorProps
> = ({
  from,
  to,
  mode,
  ...
  const handleModeChange = (newMode: StockReportDateMode) => {
